...
G_DEFINE_TYPE_WITH_PRIVATE (WorkbenchDBusPreviewer, workbench_dbus_previewer, G_TYPE_DBUS_INTERFACE_SKELETON);
                                   ...
                                   GError                 **error)
{
  g_assert (WORKBENCH_IS_DBUS_PREVIEWER (self));
  g_assert (path != NULL);
  g_assert (g_variant_is_of_type (G_VARIANT_TYPE_VARDICT));
